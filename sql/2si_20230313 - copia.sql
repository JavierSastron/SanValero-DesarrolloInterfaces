...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-03-2023 a las 09:39:35
...
CREATE TABLE `menus` (
  ...
  `texto` varchar(40) COLLATE utf8_spanish2_ci NOT NULL,
  `url` varchar(100) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `id_Padre` int(11) NOT NULL,
  `orden` int(4) NOT NULL,
  `ambito` varchar(10) COLLATE utf8_spanish2_ci DEFAULT 'publico'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
...
INSERT INTO `menus` (`id_Opcion`, `texto`, `url`, `id_Padre`, `orden`, `ambito`) VALUES
(1, 'Mantenimiento', '', 0, 1, 'admin'),
(2, 'Proximamente', NULL, 0, 2, 'publico'),
(3, 'Usuarios', 'getView(\'Users\',\'userFilterView\');', 1, 1, 'admin'),
(4, 'Menu', 'getView(\'Menu\',\'menuFilterView\');', 1, 2, 'admin');
...
(8, 2, 3, 'crear'),
(9, 2, 4, 'modificar'),
(10, 2, 5, 'cambiarEstado'),
(11, 3, 1, 'consultar'),
(12, 3, 2, 'editar'),
(13, 3, 3, 'crear'),
(14, 3, 4, 'modificar'),
(15, 3, 5, 'cambiarEstado'),
(16, 4, 1, 'consultar'),
(17, 4, 2, 'editar'),
(18, 4, 3, 'crear'),
(19, 4, 4, 'modificar'),
(20, 4, 5, 'cambiarEstado');
...
(1, 'javier', 'xx', 'xx', 'H', '2020-10-01', 'javier@2si2021.es', '976466599', 'javier', '56722ee6fafda353b3995dcd7971b537', 'S'),
...
--
ALTER TABLE `menus`
  MODIFY `id_Opcion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
--
ALTER TABLE `permisos`
  ADD CONSTRAINT `permisos_ibfk_1` FOREIGN KEY (`id_Opcion`) REFERENCES `menus` (`id_Opcion`);

--
-- Filtros para la tabla `permisosrol`
--
ALTER TABLE `permisosrol`
  ADD CONSTRAINT `permisosrol_ibfk_1` FOREIGN KEY (`id_Permiso`) REFERENCES `permisos` (`id_Permiso`),
  ADD CONSTRAINT `permisosrol_ibfk_2` FOREIGN KEY (`id_Rol`) REFERENCES `roles` (`id_Rol`);
...
--
ALTER TABLE `rolesusuarios`
  ADD CONSTRAINT `rolesusuarios_ibfk_1` FOREIGN KEY (`id_Rol`) REFERENCES `roles` (`id_Rol`),
  ADD CONSTRAINT `rolesusuarios_ibfk_2` FOREIGN KEY (`id_Usuario`) REFERENCES `usuarios` (`id_Usuario`);
COMMIT;
